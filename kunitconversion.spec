...
Source0  : https://download.kde.org/stable/frameworks/5.102/kunitconversion-5.102.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.102/kunitconversion-5.102.0.tar.xz.sig
...
%prep
%setup -q -n kunitconversion-5.102.0
cd %{_builddir}/kunitconversion-5.102.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673895783
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5UnitConversion.so.5.102.0

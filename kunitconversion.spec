...
Version  : 5.75.0
Release  : 33
URL      : https://download.kde.org/stable/frameworks/5.75/kunitconversion-5.75.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.75/kunitconversion-5.75.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.75/kunitconversion-5.75.0.tar.xz.sig
...
%prep
%setup -q -n kunitconversion-5.75.0
cd %{_builddir}/kunitconversion-5.75.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602701481
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kunitconversion-5.75.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kunitconversion/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5UnitConversion.so.5.75.0

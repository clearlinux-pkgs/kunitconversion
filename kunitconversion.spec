...
Source0  : https://download.kde.org/stable/frameworks/5.96/kunitconversion-5.96.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.96/kunitconversion-5.96.0.tar.xz.sig
...
%prep
%setup -q -n kunitconversion-5.96.0
cd %{_builddir}/kunitconversion-5.96.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657588165
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kunitconversion-5.96.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kunitconversion/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kunitconversion-5.96.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kunitconversion/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5UnitConversion.so.5.96.0

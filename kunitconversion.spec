...
Source0  : https://download.kde.org/stable/frameworks/5.48/kunitconversion-5.48.0.tar.xz
...
%prep
%setup -q -n kunitconversion-5.48.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1532318890
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5UnitConversion.so.5.48.0

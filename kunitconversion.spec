...
Source0  : https://download.kde.org/stable/frameworks/5.49/kunitconversion-5.49.0.tar.xz
...
%prep
%setup -q -n kunitconversion-5.49.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1534100483
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5UnitConversion.so.5.49.0

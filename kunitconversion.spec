...
Version  : 5.106.0
Release  : 62
URL      : https://download.kde.org/stable/frameworks/5.106/kunitconversion-5.106.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.106/kunitconversion-5.106.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.106/kunitconversion-5.106.0.tar.xz.sig
...
%prep
%setup -q -n kunitconversion-5.106.0
cd %{_builddir}/kunitconversion-5.106.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684852601
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5UnitConversion.so
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5UnitConversion.so.5
/V3/usr/lib64/libKF5UnitConversion.so.5.106.0
/usr/lib64/libKF5UnitConversion.so.5
/usr/lib64/libKF5UnitConversion.so.5.106.0

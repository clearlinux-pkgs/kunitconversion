...
Source0  : https://download.kde.org/stable/frameworks/5.97/kunitconversion-5.97.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.97/kunitconversion-5.97.0.tar.xz.sig
...
%prep
%setup -q -n kunitconversion-5.97.0
cd %{_builddir}/kunitconversion-5.97.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660519510
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5UnitConversion.so.5.97.0
